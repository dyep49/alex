...
techcrunch = Source.create(url: 'www.techcrunch.com', img_url: 'https://s3.amazonaws.com/crunchbase_prod_assets/assets/images/resized/0001/0576/10576v3-max-250x250.jpg', name: 'Techcrunch')
Source.create(url: 'www.soundcloud.com', img_url: 'http://cdn.embed.ly/providers/logos/soundcloud.png', name: 'Soundcloud')
Source.create(url: 'www.youtube.com', img_url: 'https://lh6.ggpht.com/NrQdFAdPSI9-hreB4C7HNhj3yXRiW1jqOOi7eFyakIx_IA-Im0huIeYCs5jTidMT2qA=w300', name: 'YouTube')
Source.create(url: 'www.vimeo.com', img_url: 'http://www.cmha.bc.ca/files/vimeo-icon.png', name: 'Vimeo')
Source.create(url: 'www.espn.com', img_url: 'https://yt3.ggpht.com/-yOoKXdob9y8/AAAAAAAAAAI/AAAAAAAAAAA/O9ATiv9wGJ0/s900-c-k-no/photo.jpg', name: 'ESPN')
